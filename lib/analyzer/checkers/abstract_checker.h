...
public:
    ...
    virtual void check_memory_access(const block* block, const clang::Expr* expr, memory_access_type access_type, const z3::expr& address) = 0;
protected:
    z3::context& z3_ctx;
    const block_context& block_ctx;
